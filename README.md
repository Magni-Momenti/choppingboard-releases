...
The Chopping Board is not owned by, affiliated with, or endorsed by Salad Technologies. It (optionally) utilizes API data from that platform and log data generated by it.
